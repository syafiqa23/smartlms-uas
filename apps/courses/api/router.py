...
from apps.common.api.utils import paginate_queryset, require_teacher, require_teacher_or_admin
...
# Slug is now auto-generated by Course model's save() method
...
def delete_course(request, course_id: int):
    """
    Delete a course (Teacher: only their own courses, Admin: all courses).
    ...
    course = get_object_or_404(Course, id=course_id)
    if course.teacher_id != user.id and user.role != "admin":
        raise HttpError(403, "You cannot delete this course.")
    course.delete()
