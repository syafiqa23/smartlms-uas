...
@router.get("/", response=DashboardSchema, operation_id="statistics_summary")
def statistics_summary(request):
    """
    Return API statistics with counters, charts, and recent activity.

    Example request: GET /api/v1/statistics/
